...
enum TokenType {
	...
	// Other Operators:
	INSERTION_TOKEN, ASSIGNMENT_TOKEN, PLUS_TOKEN, MINUS_TOKEN, TIMES_TOKEN, DIVIDE_TOKEN, EXP_TOKEN, BITWISE_AND_TOKEN, AND_TOKEN, BITWISE_OR_TOKEN, OR_TOKEN,
	// Other Characters:
...
const std::string gTokenTypeNames[] = {
	...
	"INSERTION", "ASSIGNMENT", "PLUS", "MINUS", "TIMES", "DIVIDE", "EXP", "BITWISEAND", "AND", "BITWISEOR" ,"OR"
