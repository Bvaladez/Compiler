...
enum TokenType {
	// Reserved Words:
	VOID_TOKEN, MAIN_TOKEN, INT_TOKEN, COUT_TOKEN, ENDL_TOKEN, IF_TOKEN, ELSE_TOKEN, WHILE_TOKEN,
	// Relational Operators:
	LESS_TOKEN, LESSEQUAL_TOKEN, GREATER_TOKEN, GREATEREQUAL_TOKEN, EQUAL_TOKEN, NOTEQUAL_TOKEN,
	// Other Operators:
	INSERTION_TOKEN, ASSIGNMENT_TOKEN, PLUS_TOKEN, PLUSEQUAL_TOKEN, MINUS_TOKEN, MINUSEQUAL_TOKEN, TIMES_TOKEN, DIVIDE_TOKEN, EXP_TOKEN, BITWISE_AND_TOKEN, AND_TOKEN, BITWISE_OR_TOKEN, OR_TOKEN,
	// Other Characters:
...
const std::string gTokenTypeNames[] = {
	"VOID", "MAIN", "INT", "COUT", "ENDL","IF", "ELSE","WHILE",
	"LESS", "LESSEQUAL", "GREATER", "GREATEREQUAL", "EQUAL", "NOTEQUAL",
	"INSERTION", "ASSIGNMENT", "PLUS", "PLUSEQUAL", "MINUS", "MINUSEQUAL", "TIMES", "DIVIDE", "EXP", "BITWISEAND", "AND", "BITWISEOR" ,"OR",
